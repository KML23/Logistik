...
$sql = "SELECT COUNT(id) AS total_barang FROM data_barang";
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="/logistik/data-barang.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="/logistik/barang-masuk.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="/logistik/order-barang.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="/logistik/distribusi-barang.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
      ...
      <div class="row">
        ...
        <div class="box box-primary">
            ...
            <div class="box-footer clearfix no-border">
                <input type="text" id="new-task" placeholder="Add new task" class="form-control" />
                <button type="button" class="btn btn-default pull-right" onclick="addItem()"><i class="fa fa-plus"></i> Add item</button>
            </div>
        </div>
        <!-- /.box -->
         <?php include 'C:\laragon\www\logistik\adminlte\dist\js\todolist.php'; ?>
